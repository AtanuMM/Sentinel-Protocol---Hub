...
export async function registerSwagger(app: FastifyInstance): Promise<void> {
  await app.register(swagger, {
    openapi: {
      openapi: "3.1.0",
      info: {
        title: "Sentinel Protocol — Email-to-FTP ingestion",
        description:
          "Fastify microservice for the Email-to-FTP pipeline. Protected routes require header **x-vault-token** (key-vault).",
